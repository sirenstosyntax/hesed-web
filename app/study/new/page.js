...
export default function NewStudyPage() {
  ...
  const [status, setStatus] = useState('idle') // idle | generating | polling | error
  ...
  // Pre-fill passage from track continue button
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(async () => {
      ...
      if (data?.study_content) {
        ...
        // If this was from a track, advance the track
